...
const SocketExample = () => {
    ...
    const { connect, setupReportUpdateListener, subscribeToReportsRoom, sendUserLocation, earthquakeAlertListener } = useSocketStore()
    ...
    return (
        <div className="p-10 flex flex-col gap-y-10">
            <h1 className="text-xl">Live Connection Status: {isSocketConnected ? '✅ Connected' : '❌ Disconnected'}</h1>
            <div>
