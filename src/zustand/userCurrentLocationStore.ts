...
export const selectUserCurrentLocation = (state: UserCurrentLocationStore) =>
  state.location
export const setUserCurrentLocation = (location: UserCurrentLocationState) =>
  useUserCurrentLocationStore.getState().setUserCurrentLocation(location)
export const clearUserCurrentLocation = () =>
  useUserCurrentLocationStore.getState().clearUserCurrentLocation()
